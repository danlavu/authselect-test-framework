...
class SSSDUtils(MultihostUtility[MultihostHost]):
    ...
    def stop(self, service="sssd") -> ProcessResult:
        """
...
class SSSDCommonConfiguration(object):
    ...
    def ldap_provider(
        ...
        """
        Configure SSSD to use the ldap identity backend to connect to IPA or AD.
        This is an alternate configuration and is rarely needed in authselect tests.
