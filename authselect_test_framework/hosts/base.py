...
from ..config import AuthselectMultihostDomain
...
class BaseHost(MultihostBackupHost[AuthselectMultihostDomain]):
    """
...
class BaseLinuxHost(MultihostHost[AuthselectMultihostDomain]):
    """
    Base Linux host.
